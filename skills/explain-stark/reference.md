...
- Build in sync: write the prompt so what is named appears when it is named ("four small nozzles light one after another", "the lobes are drawn first, then the pins"); one element per beat of the sentence.
