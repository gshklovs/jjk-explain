...
8. SUIT UP AND CARRY (the payoff on the suit itself): the improved part goes into the suit, he steps onto the assembly platform, the robot arms lock the armor on, the faceplate closes last, and armored he does the thing the concept promised (lifts the front of a car, holds a load dead steady, walks off with it). This scene carries the suit-up stills as a per-scene `"refs"` (`tony-face.jpg`, `tony-bust.jpg`, `suitup-1.jpg`, `suitup-2.jpg`, `suitup-3.jpg`). One line before the faceplate closes, none after. The viewer expects this beat; do not end on the bench.
...
AI-line shots (beat 5): frame him from behind or from the shoulders down, face out of frame, so nothing on screen can mouth the AI's words. The style's `say_lines["ai"]` already says his lips stay shut; the framing makes it certain.
