...
2. HE BUILDS IT: hands only, no face; he assembles the concept in the hologram piece by piece while talking, half to himself ("cam goes here, off center, that's the whole trick... disc on the cam... now the pins"), each part snapping into place as he names it. His line is dubbed; the AI is silent or gives one number at the end. Best for mechanisms with an order of assembly.
