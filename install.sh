...
echo "Installed: ~/.claude/skills/explain, explain-iroh and explain-hxh, explain-stark, explain-rick, explain-clav -> $HERE/skills/. In Claude Code, run: /explain <concept>, /explain-iroh <concept>, /explain-hxh <concept>, /explain-stark <concept>, /explain-rick <concept> or /explain-clav <concept>"
