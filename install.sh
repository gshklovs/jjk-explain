...
ln -sfn "$HERE/skills/explain-clav" ~/.claude/skills/explain-clav
ln -sfn "$HERE/skills/explain-matan" ~/.claude/skills/explain-matan
...
echo "Installed: ~/.claude/skills/explain, explain-iroh and explain-hxh, explain-stark, explain-rick, explain-clav, explain-matan -> $HERE/skills/. In Claude Code, run: /explain <concept>, /explain-iroh <concept>, /explain-hxh <concept>, /explain-stark <concept>, /explain-rick <concept>, /explain-clav <concept> or /explain-matan <concept>"
